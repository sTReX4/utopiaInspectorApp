      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-surface border border-line rounded-card p-8 md:p-14">
          ...
          <div className="border-b border-line pb-8 mb-10">
            ...
            <h1 className="text-4xl font-serif text-ink mb-2">Privacy Policy</h1>
          </div>

          {/* Document Body */}
          <div className="space-y-10 text-[15px] leading-[1.7] text-ink max-w-[68ch]">
            
            <section className="bg-sunken p-5 border border-line rounded-control">
              <p className="text-sm font-medium text-ink">Statutory Compliance Notice</p>
              <p className="mt-2">
            ...
            <section>
              <h2 className="text-xl font-serif text-ink mb-3">1. Data Collection Matrix</h2>
            ...
            <section>
              <h2 className="text-xl font-serif text-ink mb-3">2. Purpose of Processing</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-serif text-ink mb-3">3. Data Retention & Archiving</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-serif text-ink mb-3">4. Information Sharing & Disclosure</h2>
              <p>
            ...
            <section>
              <h2 className="text-xl font-serif text-ink mb-3">5. Personnel Rights</h2>
              <p>
